...
public class MeteoListModel extends ArrayAdapter<MeteoItem> {
    private final List<MeteoItem> listItems;

    public MeteoListModel(Context context, int resource, List<MeteoItem>
            data) {
    ...
    static{
        ...
        images.put("thunderstormspng",R.drawable.thunderstorm);
    }
    ...
    public View getView(int position, @Nullable View convertView,
        ...
        if (listItem == null) {
            listItem = LayoutInflater.from(getContext()).inflate(resource, parent
                    , false); }
        ...
        textViewTempMax.setText(String.valueOf(listItems.get(position).
                tempMax)+" C ");
        textViewTempMin.setText(String.valueOf(listItems.get(position).
                tempMin)+" C ");
        textViewPression.setText(String.valueOf(listItems.get(position).
                pression)+"hPa");
        textViewHumidite.setText(String.valueOf(listItems.get(position).
                humidite)+"%");
